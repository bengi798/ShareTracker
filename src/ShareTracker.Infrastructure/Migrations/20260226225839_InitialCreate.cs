        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfUnits = table.Column<decimal>(type: "numeric(18,4)", nullable: false),
                    TradeType = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    DateOfTrade = table.Column<DateOnly>(type: "date", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    AssetType = table.Column<string>(type: "character varying(8)", maxLength: 8, nullable: false),
                    BondCode = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    YieldPercent = table.Column<decimal>(type: "numeric(8,4)", nullable: true),
                    ...
                    CoinSymbol = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    Network = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    PurityCarats = table.Column<int>(type: "integer", nullable: true),
